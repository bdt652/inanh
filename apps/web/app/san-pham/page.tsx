...
import { buildBreadcrumbJsonLd, buildItemListJsonLd, DEFAULT_OG_IMAGE, SITE_NAME, SITE_URL } from "../lib/seo";
...
export default async function ProductsPage({ searchParams }: ProductsPageProps) {
  ...
  const itemListJsonLd = buildItemListJsonLd(products, SITE_URL);
